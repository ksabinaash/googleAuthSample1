...
using DiscountManagement.Providers;
using DiscountManagement.Results;
...
namespace DiscountManagement.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private string _applicationName = "DiscountManagement";
        private string spreadsheetId = "1BL0kWy6sfE_Nf0_QXkzb2h65FCdBXUdwBqUoav5kA38";
